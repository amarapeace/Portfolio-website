      ...
      <div className="row">
        ...
        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
          <div className="about-details">
            <Flip direction="left" duration={2000} triggerOnce={true}>
            ...
            <Fade right>
              <p>
                ...
                passion for creating dynamic and responsive user interfaces.
                With experience in building complex web applications and mobile
                apps, I have a deep understanding of the React ecosystem and its
                various tools and libraries as well as its incorporation with
                NodeJs{" "}
              </p>
